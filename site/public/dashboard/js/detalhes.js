...
async function consultarSituaçãoAtual() {
    ...
    try {
        ...
        var resposta = await fetch("../consultasBd/consultaComponentsAtual", {
            method: "POST",
            body: corpo
        });
...
async function verComponentes() {
    try {
        ...
        var corpo = new URLSearchParams(codigosistema);
        var resposta = await fetch("../consultasBd/informacaoComponentes", {
            method: "POST",
            body: corpo
        });
...
async function obterDadosGrafico() {
    ...
    try {
        ...
        var response = await fetch('../consultasBd/consultaComponentesHistorico', {
            method: "POST",
            body: corpo
        });
        if (response.ok) {
